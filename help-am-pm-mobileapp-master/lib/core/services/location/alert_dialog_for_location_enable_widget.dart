...
class AlertDialogForLocationEnableWidget extends StatelessWidget {
  final VoidCallback? onPressedOk;

  const AlertDialogForLocationEnableWidget({
    Key? key,
    this.onPressedOk,
  }) : super(key: key);
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                AppStrings.deviceLocationEnabled,
              ...
              Text(
                AppStrings.deviceLocationEnabledMsg,
                style: AppTextStyles.defaultTextStyle.copyWith(
                  fontSize: 18.fs,
