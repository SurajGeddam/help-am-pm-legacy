...
class TextWidgetForProvider extends StatelessWidget {
  final Quotes scheduleOrder;
  final OrdersType ordersType;

  const TextWidgetForProvider({
    Key? key,
      ...
      child: Container(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              RowItemsWidget(
                text1: scheduleOrder.customerName,
                text2:
                    "${AppUtils.getCurrencySymbol(scheduleOrder.currency)}${scheduleOrder.totalBill.toStringAsFixed(2)}",
              ...
              Text(scheduleOrder.orderNumber,
              ...
              Text(AppUtils.getLocationName(scheduleOrder.customerAddress),
                  style: AppTextStyles.defaultTextStyle.copyWith(
                    fontSize: 12.fs,
                    fontWeight: FontWeight.w500,
                    color: AppColors.black,
