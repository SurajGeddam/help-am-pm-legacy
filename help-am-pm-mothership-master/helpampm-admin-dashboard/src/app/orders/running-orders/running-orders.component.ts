...
@Component({
  ...
  styleUrls: ['./running-orders.component.sass']
})
export class RunningOrdersComponent extends UnsubscribeOnDestroyAdapter implements OnInit {
  ...
  public loadData(pageParams) {
    this.orderService.getRunningOrders(pageParams).subscribe(
      (res: any) => {
