...
export class UserManagementComponent implements OnInit {
  ...
  public loadData() {
    this.userManagementService.getAllEmployees(this.userDetails.companyUniqueId).subscribe((res: any) => {
  ...
  //   this.userManagementService.updateEmployee(user,this.userDetails.).subscribe((res: any) => {
  //     var data: any;
  //     data = res;
  //     if (data.enabled) {
